...
res.render('index', { title: 'watches App', user : req.user });
});
router.get('/register', function(req, res) {
res.render('register', { title: 'watches App Registration'});
});
...
message: 'Registration error', account : req.body.username })
  ...
  res.render('login', { title: 'Watches App Login', user : req.user });
  });
